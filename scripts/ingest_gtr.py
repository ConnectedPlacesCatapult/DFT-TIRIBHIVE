...
def main():
    ...
    print(f"{'=' * 50}")
    print(f"\nNext steps:")
    print(f"  1. Run classification step to set cpc_modes, cpc_themes, transport_relevance_score")
    print(f"  2. Run outcomes enrichment for high-relevance projects")
    print(f"  3. Run embedding step")
    print(f"  4. Create pgvector indexes")
